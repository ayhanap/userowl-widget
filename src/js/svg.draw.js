...
;(function () {
    ...
    PaintHandler.prototype.getCursorCoordinates = function(event){
    ...
    PaintHandler.prototype.start = function (event) {
        ...
        // save the startpoint
        this.startPoint = this.snapToGrid(this.transformPoint(x, y));
        ...
        // We need to bind the update-function to the mousemove event to keep track of the cursor
        SVG.on(window, 'touchmove.draw', function (e) {
            _this.update(e);
        });
    ...
    SVG.Element.prototype.draw.extend('rect image', {
        ...
        calc:function (e) {
            ...
            var {x, y} = this.getCursorCoordinates(e);
