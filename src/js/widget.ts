...
async function getWidgetToken() {
  ...
  if (widgetTokenInLocalStorage) {
    ...
    if(exp_date < new Date("2024-01-12T09:00:00.000+03:00")){
      localStorage.removeItem(widgetTokenInLocalStorage);
...
export const getFeedbackFormIframe = () => {
  return feedbackFormIframe;
};

export const getWidgetIframe = () => {
  return feedbackButtonIframe;
};
